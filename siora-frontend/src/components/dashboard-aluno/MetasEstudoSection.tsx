...
export function MetasEstudoSection({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm min-h-[500px] flex flex-col">
      ...
      <form onSubmit={onAddMeta} className="flex gap-2 mb-10">
        ...
        <button
          type="submit"
          className="bg-[#3B82F6] hover:bg-blue-600 text-white font-semibold px-4 py-3 rounded-lg text-xs transition-colors flex items-center gap-1.5 shrink-0 cursor-pointer shadow-sm"
        >
