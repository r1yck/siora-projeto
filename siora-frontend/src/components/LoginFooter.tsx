...
export function LoginFooter() {
  return (
    <div className="w-full flex justify-between items-center text-[10px] sm:text-[11px] text-slate-400 font-medium px-2 sm:px-6 md:px-12 mt-auto pb-1 md:pb-0 md:absolute md:bottom-6 left-0">
