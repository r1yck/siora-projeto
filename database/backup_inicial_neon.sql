-- Reset de Schema para garantir ambiente limpo
...
ALTER TABLE ONLY public.avaliacoes ADD CONSTRAINT atividades_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.comunicados_mural ADD CONSTRAINT comunicados_mural_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.comunicados ADD CONSTRAINT comunicados_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.disciplinas ADD CONSTRAINT disciplinas_codigo_turma_key UNIQUE (codigo_turma);
ALTER TABLE ONLY public.disciplinas ADD CONSTRAINT disciplinas_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.matriculas ADD CONSTRAINT estudante_disciplina_unico UNIQUE (estudante_id, disciplina_id);
ALTER TABLE ONLY public.estudantes ADD CONSTRAINT estudantes_pkey PRIMARY KEY (usuario_id);
ALTER TABLE ONLY public.horarios_aula ADD CONSTRAINT horarios_aula_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.materiais_aula ADD CONSTRAINT materiais_aula_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.matriculas ADD CONSTRAINT matriculas_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.professores ADD CONSTRAINT professores_pkey PRIMARY KEY (usuario_id);
ALTER TABLE ONLY public.submissoes_avaliacoes ADD CONSTRAINT submissao_estudante_avaliacao_unica UNIQUE (avaliacao_id, estudante_id);
ALTER TABLE ONLY public.submissoes_avaliacoes ADD CONSTRAINT submissoes_avaliacoes_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.tarefas_privadas ADD CONSTRAINT tarefas_privadas_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.usuarios ADD CONSTRAINT usuarios_email_key UNIQUE (matricula_siape);
...
ALTER TABLE ONLY public.avaliacoes ADD CONSTRAINT atividades_disciplina_id_fkey FOREIGN KEY (disciplina_id) REFERENCES public.disciplinas(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.comunicados ADD CONSTRAINT comunicados_disciplina_id_fkey FOREIGN KEY (disciplina_id) REFERENCES public.disciplinas(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.comunicados_mural ADD CONSTRAINT comunicados_mural_disciplina_id_fkey FOREIGN KEY (disciplina_id) REFERENCES public.disciplinas(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.disciplinas ADD CONSTRAINT disciplinas_professor_id_fkey FOREIGN KEY (professor_id) REFERENCES public.professores(usuario_id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.estudantes ADD CONSTRAINT estudantes_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.submissoes_avaliacoes ADD CONSTRAINT fk_submissao_avaliacao FOREIGN KEY (avaliacao_id) REFERENCES public.avaliacoes(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.submissoes_avaliacoes ADD CONSTRAINT fk_submissao_estudante FOREIGN KEY (estudante_id) REFERENCES public.estudantes(usuario_id) ON DELETE CASCADE;
ALTER TABLE ONLY public.horarios_aula ADD CONSTRAINT horarios_aula_disciplina_id_fkey FOREIGN KEY (disciplina_id) REFERENCES public.disciplinas(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.materiais_aula ADD CONSTRAINT materiais_aula_disciplina_id_fkey FOREIGN KEY (disciplina_id) REFERENCES public.disciplinas(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.matriculas ADD CONSTRAINT matriculas_disciplina_id_fkey FOREIGN KEY (disciplina_id) REFERENCES public.disciplinas(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.matriculas ADD CONSTRAINT matriculas_estudante_id_fkey FOREIGN KEY (estudante_id) REFERENCES public.estudantes(usuario_id) ON DELETE CASCADE;
ALTER TABLE ONLY public.professores ADD CONSTRAINT professores_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.tarefas_privadas ADD CONSTRAINT tarefas_privadas_estudante_id_fkey FOREIGN KEY (estudante_id) REFERENCES public.estudantes(usuario_id) ON DELETE CASCADE;